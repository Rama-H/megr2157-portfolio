...
My name is Rama Hamid, and I am a Mechanical Engineering student at the University of North Carolina at Charlotte with a concentration in Biomedical Engineering. I chose mechanical engineering because I enjoy understanding how physical systems work and using engineering principles to solve practical problems. My interest in biomedical engineering comes from wanting to apply that technical foundation to healthcare and medical technology. I am particularly interested in areas where engineering can interact directly with medicine, including biomechanics, biomaterials, medical devices, and clinical applications.

As I continue developing as an engineer, I want to become someone who can approach an unfamiliar problem systematically, identify the relevant engineering principles, make reasonable assumptions, and justify the decisions made during the design process. My coursework in mechanics, thermodynamics, solid mechanics, computational methods, and electrical and mechatronics systems has helped me build that foundation. Research experiences related to biomedical engineering and biomaterials have also helped me see how engineering concepts can be applied to real healthcare challenges.

I am particularly interested in a future career involving biomedical engineering and medical technology. I want to gain experience working with engineers and healthcare professionals and better understand how engineering decisions affect real clinical needs. I also value continuous improvement and learning from mistakes. Engineering problems do not always have perfect conditions or predictable outcomes, so I believe an important part of becoming an engineer is learning how to adapt, evaluate a situation, and make the best defensible decision with the information and resources available.
